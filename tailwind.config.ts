  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        card: {
          ...
          portfolio: {
            ...
            "text-neon": "hsl(var(--portfolio-text-neon))",
            "neon-cyan": "hsl(var(--portfolio-neon-cyan))",
            "neon-pink": "hsl(var(--portfolio-neon-pink))",
      ...
      keyframes: {
        ...
        "glow": {
          "0%, 100%": {
            boxShadow: "0 0 20px hsl(var(--portfolio-primary) / 0.3)"
          },
          "50%": {
            boxShadow: "0 0 40px hsl(var(--portfolio-primary) / 0.6)"
          }
        },
        "float": {
          "0%, 100%": {
